...
<body onload="window.print();">
    ...
    <p>&nbsp;</p>
    <p style="text-align: center;"><strong>LAPORAN SURAT KELUAR<br /></strong></p>
    ...
    <table style="border-collapse: collapse; width: 100%; height: 54px;" border="1">
        <tbody>
            <tr style="height: 18px;">
                ...
                <td style="width: 17%; text-align: center; padding:5px"><strong>No. Surat</strong></td>
                <td style="width: 10%; text-align: center; padding:5px"><strong>Tgl. Surat</strong></td>
                <td style="width: 15%; text-align: center; padding:5px"><strong>Bagian</strong></td>
                <td style="width: 15%; text-align: center; padding:5px"><strong>Tujuan</strong></td>
                <td style="width: 20%; text-align: center; padding:5px"><strong>Isi Singkat</strong></td>
                <td style="width: 20%; text-align: center; padding:5px"><strong>Jenis</strong></td>
            </tr>
            <?php
            $no = 1;
            ...
            <tr style="height: 18px;">
                ...
                <td style="padding:5px"><?php echo $data->no_suratkeluar ?></td>
                <td style="padding:5px"><?php echo $this->string_->dbdate_to_indo($data->tgl_suratkeluar) ?></td>
                <td style="padding:5px"><?php echo $data->nama_bagian ?></td>
                <td style="padding:5px"><?php echo $data->alamat_suratkeluar ?></td>
                <td style="padding:5px"><?php echo $data->isi_singkat ?></td>
                <td style="padding:5px"><?php echo $data->nama_jenis ?></td>
            </tr>
            <?php
            }
            ?>
